 ...
 */
/*
 * ARM Cortex Mx Processor NVIC ISERx register addresses (for interrupts setting/enabling)
 */
...
/*
 * ARM Cortex Mx Processor NVIC ICERx register addresses (for interrupts clearing)
 */
...
/*
 **********************************************************
 * Bit position definiton of SPI peripheral
 **********************************************************
 */
/*
